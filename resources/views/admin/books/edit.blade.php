...
@section('heading') Edit Book @endsection
@section('content')
<div class="row justify-content-center">
    <div class="card mb-4 col-md-8">
        <div class="card-header text-">Edit Book</div>
        <div class="card-body">
            <form action="{{ route('books.update', $book) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    <label for="cover_image" class="col-md-4 col-form-label text-md-right">Image Cover</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="category" class="form-control" name="category">
                            <option disabled {{ $book->category == null ? "selected" : ""  }}>Select a Category</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="authors" multiple class="form-control" name="authors[]">
                            <option disabled {{ $book->authors()->count() == 0 ? 'selected' : '' }}>Select Authors</option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select id="publisher" class="form-control" name="publisher">
                            <option disabled {{ $book->publisher == null ? 'selected' : '' }}>Select a Publisher</option>
